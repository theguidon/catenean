        ...
        <div className={styles.sectionTitle}>
         ...
         <div className={styles.content}>
            ...
            <motion.div className={styles.smallQuoteContainer}
                ...
                >
                    <motion.p
                    variants={{ hidden:{opacity:0}, show:{opacity:1, transition: { duration: 1.0, ease: "easeOut" }}}} style={{marginBottom:0}}
                    >
                        Here’s a vulnerable life that needs to be cared for, needs to be helped. That’s just it
                    </motion.p>
                </motion.div>
                <motion.p
                    variants={{ hidden:{opacity:0}, show:{opacity:1, transition: { duration: 1.0, ease: "easeOut", delay: 1.5}}}}
                >
                    he remarks.
                </motion.p>
            </motion.div>
